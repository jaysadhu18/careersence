  ...
  return (
    <aside className="flex h-screen w-64 shrink-0 flex-col border-r border-[var(--color-border)] bg-[var(--color-surface)]">
      ...
      <button
        ...
        className="flex h-16 w-full items-center gap-3 border-b border-[var(--color-border)] px-6 transition-colors hover:bg-[var(--color-background)]"
      >
        ...
        <div className="text-left">
          ...
          <p className="text-xs text-[var(--color-text-muted)]">CareerSense</p>
        </div>
      </button>
      ...
      <nav className="flex-1 overflow-y-auto p-4">
        ...
        <div className="mt-6 border-t border-[var(--color-border)] pt-4">
          ...
          <button
            onClick={() => signOut({ callbackUrl: "/signin" })}
            className="flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium text-[var(--color-text-muted)] transition-colors hover:bg-[var(--color-background)] hover:text-[var(--color-text)]"
          >
            <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
